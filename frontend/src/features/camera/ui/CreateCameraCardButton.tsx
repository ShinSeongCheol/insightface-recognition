...
export const CreateCameraCardButton = () => {
    ...
    return(
        <div
            className="bg-gray-50/50 h-full rounded-3xl border-2 border-dashed border-gray-200 hover:border-blue-400 hover:bg-blue-50/30 transition-all duration-300 group cursor-pointer flex flex-col items-center justify-center"
